...
\centering
\includegraphics[width=0.94\textwidth,height=0.72\textheight,keepaspectratio]{../../results/figures/latest/ccc_mse_by_k.png}
\end{frame}
...
\begin{itemize}
  ...
  \item Use normalized CCC for cross-dataset comparison.
