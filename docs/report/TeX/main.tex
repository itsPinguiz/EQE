...
only five to nine features. MAPLE can have moderate full MSE but poor top-$K$
...
is shown. Two explanations with identical full MSE can have different CCC values,
revealing distinct levels of compact faithfulness.
